...
public class PlaintextDiff {
    ...
    /**
     * Returns the number of seconds to map a diff before giving up (0 for infinity).
     *
     * @return the number of seconds to map a diff
     */
    ...
    /**
     * Sets the number of seconds to map a diff before giving up (0 for infinity).
     *
     * @param timeout
     *            the number of seconds to map a diff
     */
    ...
    /**
     * Returns the cost of an empty edit operation in terms of edit characters.
     *
     * @return the cost of an empty operation
     */
    ...
    /**
     * Sets the cost of an empty edit operation in terms of edit characters.
     *
     * @param editCost
     *            the cost of an empty operation
     */
     ...
     * allows the 'checklines' of diff() to be optional. Most of the time checklines is wanted, so
     * default to true.
     *
     * @param text1
     ...
     * @return Linked List of Diff objects.
     */
    public LinkedList<Diff> diff(String text1, String text2, boolean checklines) {
     ...
     * @return Linked List of Diff objects.
     */
    private LinkedList<Diff> diff(String text1, String text2, boolean checklines, long deadline) {
        // Check for null inputs.
        if (text1 == null || text2 == null) {
            throw new IllegalArgumentException("Null inputs. (diff)");
        }
    ...
    private LinkedList<Diff> diffCompute(String text1, String text2, boolean checklines,
        ...
        if (hm != null) {
            ...
            LinkedList<Diff> diffs_a = diff(text1_a, text2_a, checklines, deadline);
            LinkedList<Diff> diffs_b = diff(text1_b, text2_b, checklines, deadline);
            // Merge the results.
            diffs = diffs_a;
        ...
        while (thisDiff != null) {
            ...
            case EQUAL:
                ...
                if (count_delete >= 1 && count_insert >= 1) {
                    ...
                    for (Diff newDiff : diff(text_delete, text_insert, false, deadline)) {
                        pointer.add(newDiff);
                    }
                }
                count_insert = 0;
     ...
     *            LinkedList of Diff objects.
     */
    public void cleanupSemantic(LinkedList<Diff> diffs) {
        if (diffs.isEmpty()) {
            return;
        }
    ...
    public void diffCleanupEfficiency(LinkedList<Diff> diffs) {
        ...
        while (thisDiff != null) {
            if (thisDiff.operation == Operation.EQUAL) {
                 ...
                 */
                if (lastequality != null
                        && (pre_ins && pre_del && post_ins && post_del || lastequality.length() < editCost / 2
        ...
        for (String token : tokens) {
            ...
            case '+':
                ...
                try {
                    ...
                    throw new IllegalArgumentException("Illegal escape in diffFromDelta: " + param,
                            e);
                }
            ...
            case '=':
                ...
                try {
                    ...
                    throw new IllegalArgumentException("Invalid number in diffFromDelta: " + param,
                            e);
                }
                if (n < 0) {
            ...
            default:
                ...
                throw new IllegalArgumentException("Invalid diff operation in diffFromDelta: "
                        + token.charAt(0));
            }
        }
