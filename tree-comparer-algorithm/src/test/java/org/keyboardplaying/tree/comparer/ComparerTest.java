...
public class ComparerTest {
	...
	public void testComparison() {
		...
		Tree<Versions<String>, Versions<String>> result = comparer
		...
		versions.set(1, null);
		versions.set(2, "A11");
		assertEquals(versions, nod.getChildren().get(0).getChildren().get(0)
				.getNodeInfo());
		versions.set(0, null);
		versions.set(1, "A13");
		versions.set(2, null);
		assertEquals(versions, nod.getChildren().get(0).getChildren().get(2)
				.getNodeInfo());
		versions.set(0, "A12");
		versions.set(1, "A12");
		versions.set(2, "A12");
		assertEquals(versions, nod.getChildren().get(0).getChildren().get(1)
				.getNodeInfo());
		versions.set(0, "A2");
		versions.set(1, null);
		versions.set(2, null);
		...
		versions.set(0, "A21");
		assertEquals(versions, nod.getChildren().get(1).getChildren().get(0)
				.getNodeInfo());
		versions.set(0, null);
		versions.set(1, "A3");
		versions.set(2, "A3");
