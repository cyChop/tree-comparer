 ...
 * <p/>
 * This {@link FileSystemElementInfo} describes a file (as opposed to a
 * directory) on the file system. Two files are deemed equal if they have the
 * same name (case-sensitive), same weight and same MD5 checksum.
 * 
...
public class FileInfo extends FileSystemElementInfo {
	 ...
	 * modified.
	 * 
	 * @return a {@code long} value representing the time the file was last
	 *         modified, measured in milliseconds since the epoch (00:00:00 GMT,
	 *         January 1, 1970), or {@code 0L} if the file does not exist or if
	 *         an I/O error occurs
	 */
